...
//                    Toast.makeText(context, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void callSdk(FortRequest fortrequest) {
        ...
        try {
            FortSdk.getInstance().registerCallback(context, fortrequest, testing ? FortSdk.ENVIRONMENT.PRODUCTION : FortSdk.ENVIRONMENT.PRODUCTION, REQUEST_PAYMENT, fortCallback, true, callback);
        } catch (Exception e) {
